...
import './Header.scss'
import NightLogo from '../../assests/Logo/speakify-favicon-white.png'
import LightLogo from '../../assests/Logo/speakify-favicon-black.png'
        ...
        <header className='header'>
            <div className="navbar bg-base-100">
                <div className="flex-1">
                    <img
                        src={theme === 'light' ? LightLogo : NightLogo}
                        alt='logo'
                ...
                <div className="flex justify-end flex-1 px-2">
                    ...
                    <div className="flex items-stretch">
                        <div className="dropdown dropdown-end">
                            <div tabIndex={0} role="button" className="btn btn-ghost rounded-btn m-2"><PersonOutlinedIcon sx={{ fontSize: 50 }} /></div>
